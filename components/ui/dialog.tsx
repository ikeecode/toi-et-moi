        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute right-3 top-3 text-muted-foreground hover:bg-white/[0.05] hover:text-foreground"
                size="icon-sm"
              />
            }
          >
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-5 -mb-5 flex flex-col-reverse gap-2 rounded-b-[1.75rem] border-t border-white/8 bg-white/[0.02] p-5 sm:-mx-6 sm:-mb-6 sm:flex-row sm:justify-end sm:p-6",
        className
      )}
      {...props}
    >
